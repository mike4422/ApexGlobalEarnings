...
function randomAmountUsd(type?: "WITHDRAWAL" | "DEPOSIT") {
  ...
  const depositBuckets = [250, 350, 500, 750, 900, 1200, 1500, 2000, 2500, 3000, 4500, 5000, 8000, 11000, 19000, 23000, 24000, 33000, 44000, 50000, 88000,1000000, 550000, 670000, 950, 1450, 1290, 199, 3455, 5467, 89897, 1020300, 2345000];
  const withdrawalBuckets = [250, 350, 500, 750, 900, 1200, 1500, 2000, 2500, 3000, 4500, 5000, 8000, 11000, 19000, 23000, 24000, 33000, 44000, 50000, 88000, 500000, 850000, 300000, 1200000, 980000, 880000, 750000, 540000, 45000, 32450];
